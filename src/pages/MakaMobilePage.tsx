      ...
      <main id="main-content">
        ...
        <section className={styles.pageHero}>
          <div className={styles.heroContent}>
            ...
            <h1>
              MAKA OWS · <span>App Android</span>
            </h1>

            <p className={styles.heroDesc}>
              Aplicación Android nativa para la gestión de bodas. Desarrollé el
              módulo móvil completo: desde la arquitectura de autenticación
              segura hasta el módulo de eventos con paginación real, consumiendo
              5 microservicios NestJS desplegados en AWS.
            </p>
        ...
        <section className={styles.container}>
          <FadeInView>
            <h2 className={styles.sectionTitle}>
              Sprint 3: De Expo a Kotlin nativo
            </h2>
            <div className={styles.gridTwo}>
              <div className={`${styles.rebootCard} ${styles.old}`}>
                <h3>
                  <i
                    className={`fas fa-times-circle ${styles.iconWarning}`}
                    aria-hidden="true"
                  ></i>
                ...
                <ul>
                  <li>
                    <i
                      className={`fas fa-times ${styles.iconWarning} ${styles.iconList}`}
                      aria-hidden="true"
                    ></i>{" "}
                    Limitaciones de acceso a APIs nativas de Android
                  </li>
                  <li>
                    <i
                      className={`fas fa-times ${styles.iconWarning} ${styles.iconList}`}
                      aria-hidden="true"
                    ></i>{" "}
                    Dependencia del runtime de Expo
                  </li>
                  <li>
                    <i
                      className={`fas fa-times ${styles.iconWarning} ${styles.iconList}`}
                      aria-hidden="true"
                    ></i>{" "}
                    Rendimiento subóptimo en gama media
                  </li>
                  <li>
                    <i
                      className={`fas fa-times ${styles.iconWarning} ${styles.iconList}`}
                      aria-hidden="true"
                    ></i>{" "}
                    Abstracción alejada del ecosistema Android
                  </li>
                </ul>
              </div>
              ...
              <div className={`${styles.rebootCard} ${styles.new}`}>
                <h3>
                  <i
                    className={`fas fa-check-circle ${styles.iconAccent}`}
                    aria-hidden="true"
                  ></i>
                ...
                <ul>
                  <li>
                    <i
                      className={`fas fa-check ${styles.iconAccent} ${styles.iconList}`}
                      aria-hidden="true"
                    ></i>{" "}
                  ...
                  <li>
                    <i
                      ...
                      aria-hidden="true"
                    ></i>{" "}
                    TokenAuthenticator con renovación automática en 401
                  </li>
                  <li>
                    <i
                      className={`fas fa-check ${styles.iconAccent} ${styles.iconList}`}
                  ...
                  <li>
                    <i
                      ...
                      aria-hidden="true"
                    ></i>{" "}
                    BuildConfig para entornos de depuración y producción
                  </li>
                </ul>
              </div>
            </div>
          ...
          <FadeInView>
            ...
            <div className={styles.gridThree}>
              <div className={styles.stackCard}>
                <h3>
                  <i className="fab fa-android" aria-hidden="true"></i> Núcleo
                  Android
                </h3>
              ...
              <div className={styles.stackCard}>
                ...
                <div className={styles.stackBadges}>
                  ...
                  <span className={styles.badge}>
                    TokenAuthenticator (renovación automática)
                  </span>
                  <span className={styles.badge}>
              ...
              <div className={styles.stackCard}>
                ...
                <div className={styles.stackBadges}>
                  ...
                  <span className={styles.badge}>
                    Git Flow + commits convencionales
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className={styles.timeline}>
            <FadeInView delay={0}>
              <div className={styles.timelineItem}>
                ...
                <ul>
                  ...
                  <li>
                    Pantalla de inicio de sesión con validación en tiempo real
                  </li>
            ...
            <FadeInView delay={0.1}>
              <div className={styles.timelineItem}>
                ...
                <ul>
                  ...
                  <li>
                    TokenAuthenticator con refresh automático transparente
                  </li>
            ...
            <FadeInView delay={0.2}>
              <div className={styles.timelineItem}>
                ...
                <ul>
                  <li>
                    Modelos de dominio: Evento, EventosPaginados,
                    CronogramaItem, InventarioAsignado
                  </li>
                  <li>
                    EventosRepository con Result&lt;T&gt; y mapeo de errores por
                    código HTTP
                  </li>
                  <li>
                    EventosScreen: búsqueda en tiempo real, FilterChips por
                    estatus, paginación con metadatos del backend
                  </li>
                  <li>
                    EventoDetalleScreen: info general, cliente, presupuesto,
                    cronograma, inventario asignado
                  </li>
                  <li>
                    ConfiguraciónScreen: perfil real, cambio de contraseña
                    (validación estricta)
                  </li>
                  <li>
                    Flujos completos de recuperación y restablecimiento de
                    contraseña con bloqueo temporal anti-spam
                  </li>
                </ul>
              </div>
            </FadeInView>
          ...
          <FadeInView>
            ...
            <div className={styles.diagram}>
              ...
              <div className={styles.diagramNode}>
                LoginViewModel · StateFlow&lt;LoginState&gt;
              </div>
              <div className={styles.diagramArrow}></div>
              ...
              <div className={styles.diagramNode}>
                TokenAuthenticator
                <br />→ POST /auth/refresh
                <br />→ nuevo AccessToken
              </div>
            </div>
          </FadeInView>
        </section>
